  ...
  return (
    <Box sx={{ p: 4, bgcolor: '#f8fafc', minHeight: '100vh' }}>
      ...
      <Stack direction="row" justifyContent="space-between" alignItems="center" sx={{ mb: 4 }}>
        <Box>
          <Typography variant="h4" fontWeight="bold" gutterBottom>Marketing Overview</Typography>
          <Typography color="text.secondary">Manage your campaigns, discounts, and promotional insights.</Typography>
        </Box>
          ...
          <Card sx={{ p: 3, borderRadius: 4, boxShadow: '0 2px 10px rgba(0,0,0,0.03)' }}>
            <Stack direction="row" justifyContent="space-between" alignItems="center" mb={2}>
                ...
                <Stack direction="row" spacing={1} sx={{ bgcolor: '#f1f5f9', p: 0.5, borderRadius: 2 }}>
                    <Button size="small" variant="contained" sx={{ bgcolor: 'white', color: 'black', boxShadow: 'none', '&:hover': { bgcolor: 'white' } }}>30 Days</Button>
                    <Button size="small" sx={{ color: 'text.secondary' }}>7 Days</Button>
                </Stack>
            </Stack>
